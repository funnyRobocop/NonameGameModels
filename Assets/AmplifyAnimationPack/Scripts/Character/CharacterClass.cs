...
namespace AmplifyAnimationPack
{
	...
	public class CharacterClass : MonoBehaviour
	{
...
#if CINEMACHINE_PRESENT
		[SerializeField]
		private Unity.Cinemachine.CinemachineFreeLook followCam;
		private Unity.Cinemachine.CinemachineCameraOffset followCamOffset;
		private Unity.Cinemachine.CinemachineBasicMultiChannelPerlin[] cameraNoises;
		[SerializeField]
		private Unity.Cinemachine.CinemachineFreeLook lockCam;
#endif
...
#if CINEMACHINE_PRESENT
			followCamOffset = followCam.GetComponent<Unity.Cinemachine.CinemachineCameraOffset>();
			cameraNoises = new Unity.Cinemachine.CinemachineBasicMultiChannelPerlin[ 3 ]
			{
			followCam.GetRig(0).GetCinemachineComponent<Unity.Cinemachine.CinemachineBasicMultiChannelPerlin>(),
			followCam.GetRig(1).GetCinemachineComponent<Unity.Cinemachine.CinemachineBasicMultiChannelPerlin>(),
			followCam.GetRig(2).GetCinemachineComponent<Unity.Cinemachine.CinemachineBasicMultiChannelPerlin>()
			};
#else
		...
		private void UpdateCamera()
		{
			...
			//followCamOffset.m_ = Vector3.Lerp( followCamOffset.m_Offset , cameraTargetOffset , 0.1f );
#else
			DebugCinemachineError();
#endif
